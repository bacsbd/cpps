...
import EditContest from 'components/contestPortal/EditContest.js';
import SingleContestContainer from 'components/contestPortal/SingleContestContainer.js';
    ...
    return (
      <main>
        <Switch>
          ...
          <Route
            exact
            path="/classroom/:classId/addStudent"
            component={AddStudent}
          />
          <Route
            exact
            path="/classroom/:classId/removeStudent"
            component={RemoveStudent}
          />
          <Route
            exact
            path="/classroom/:classId/deleteClass"
            component={DeleteClass}
          />
          <Route
            exact
            path="/classroom/:classId/whoSolvedIt"
            component={WhoSolvedIt}
          />
          <Route
            exact
            path="/classroom/:classId/leaderboard"
          ...
          <Route
            exact
            path="/classroom/:classId/contest/add-contest"
            component={AddContest}
          />
          <Route
            exact
            path="/classroom/:classId/contest/:contestId/add-standings"
            component={AddStandings}
          />
          <Route
            exact
            path="/classroom/:classId/contest/:contestId"
            component={SingleContestContainer}
          />
          <Route
            exact
            path="/classroom/:classId/contest/:contestId/edit"
          ...
          <Route
            exact
            path="/problemList/:problemListId"
